      ...
      <Tabs defaultValue="general" className="w-full shadow-sm rounded-lg overflow-hidden border border-border bg-card">
        ...
        <div className="p-6">
          ...
          <TabsContent value="usuarios" className="m-0">
            <div className="max-w-2xl border-2 border-dashed border-border rounded-xl p-12 text-center flex flex-col items-center bg-secondary/10">
              <Users className="w-16 h-16 text-muted-foreground opacity-50 mb-4" />
              <h3 className="text-xl font-bold text-foreground mb-2">Gestión de Empleados</h3>
              <p className="text-muted-foreground mb-6 max-w-md">
                Próximamente. Acá vas a poder crear usuarios para tus mecánicos o recepcionistas y decidir qué pantallas pueden ver (Ej: Bloquear el acceso a la Caja).
              </p>
              <Button variant="outline" disabled>Módulo en desarrollo</Button>
            </div>
          </TabsContent>
